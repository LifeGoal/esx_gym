					...
					if training == false then
						...
						if membership == true then
							...
							SetTimeout(420000, function()
								StatSetInt("MP0_STRENGTH", 90, true)
							end)
							SetTimeout(840000, function()
								StatSetInt("MP0_STRENGTH", 80, true)
							end)
							SetTimeout(1260000, function()
								StatSetInt("MP0_STRENGTH", 70, true)
							end)
							SetTimeout(1680000, function()
								StatSetInt("MP0_STRENGTH", 60, true)
							end)
							SetTimeout(2100000, function()
								StatSetInt("MP0_STRENGTH", 50, true)
							end)
							SetTimeout(2520000, function()
								StatSetInt("MP0_STRENGTH", 40, true)
							end)
							SetTimeout(2940000, function()
								StatSetInt("MP0_STRENGTH", 30, true)
							end)
							SetTimeout(3360000, function()
								StatSetInt("MP0_STRENGTH", 20, true)
							end)
							SetTimeout(3780000, function()
								StatSetInt("MP0_STRENGTH", 10, true)
							end)
							SetTimeout(4200000, function()
				...
				if IsControlJustPressed(0, Keys['E']) then
					if training == false then
						...
						if membership == true then	
							...
							SetTimeout(420000, function()
								StatSetInt("MP0_STAMINA", 90, true)
							end)
							SetTimeout(840000, function()
								StatSetInt("MP0_STAMINA", 80, true)
							end)
							SetTimeout(1260000, function()
								StatSetInt("MP0_STAMINA", 70, true)
							end)
							SetTimeout(1680000, function()
								StatSetInt("MP0_STAMINA", 60, true)
							end)
							SetTimeout(2100000, function()
								StatSetInt("MP0_STAMINA", 50, true)
							end)
							SetTimeout(2520000, function()
								StatSetInt("MP0_STAMINA", 40, true)
							end)
							SetTimeout(2940000, function()
								StatSetInt("MP0_STAMINA", 30, true)
							end)
							SetTimeout(3360000, function()
